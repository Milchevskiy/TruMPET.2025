...
Before running any scripts, carefully check all directory paths and file names in files TruMPET_cpu.py and TruMPET_gpu.py. The default paths are the following:
```
