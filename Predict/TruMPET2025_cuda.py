...
MODEL_PATH      = "Models/mix/1024_4_cuda.pt"
...
# FIX: обратный словарь для синтеза aa3 из aa1 (FASTA)
AA1_TO_AA3 = {
    "A":"ALA","R":"ARG","N":"ASN","D":"ASP","C":"CYS",
    "Q":"GLN","E":"GLU","G":"GLY","H":"HIS","I":"ILE",
    "L":"LEU","K":"LYS","M":"MET","F":"PHE","P":"PRO",
    "S":"SER","T":"THR","W":"TRP","Y":"TYR","V":"VAL",
    # неканонические/неизвестные символы:
...
def parse_args():
    ...
    if not args.data and not args.fasta:
        p.error("нужно указать хотя бы один источник: -d и/или -f")
    return args
