...
from _Log_occurence_differrence_numba_INV import _Log_occurence_differrence_numba_INV

#_Log_occurence_differrence_INV  W5_01234_dx2 0     1
class _Log_occurence_differrence_INV:
...
#        global_array = self.freq_extrap.tot_distance_to_clusters_sum
        ...
        current_array = self.freq_extrap.inverse_distance_to_clusters_sum[position_in_chain]
        global_array = self.freq_extrap.tot_inverse_distance_to_clusters_sum
    ...
    def calc_vectorized(self) -> np.ndarray:
      ...
      return _Log_occurence_differrence_numba_INV(
        occurence=occurence,
        local=local,
        global_=global_,
